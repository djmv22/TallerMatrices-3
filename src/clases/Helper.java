...
public class Helper {
    ...
    public static String recorridoTres(JTable tabla) {
        ...
        for (int i = 1; i <= nf/2; i++) {
            aux = aux + Helper.recorridoHaciaDerecha(m, (nf - 1) / 2 - j, (nc - 1) / 2 -j, (nc - 1) / 2 + j);
            aux = aux + Helper.recorridoHaciaAbajo(m, (nc - 1) / 2 + i, (nf - 1) / 2 - j, (nc - 1) / 2 + j);
            aux = aux + Helper.recorridoHaciaIzquierda(m, (nc - 1) / 2 + i, (nf - 1) / 2 + i, (nf - 1) / 2 - j);
            if (i != nf / 2) {
                aux = aux + Helper.recorridoHaciaArriba(m, (nc - 1) / 2 - i, (nf - 1) / 2 + i, (nf - 1) / 2 - j);
            }
            j=j+1;
        }
        aux = aux.substring(0, aux.length() - 2) + ".";
    ...
    public static String recorridoCuatro(JTable tabla) {
        ...
        aux = aux + Helper.recorridoHaciaDerecha(m, 0);
        aux = aux + Helper.recorridoDiagonalSecundariaAbajo(m, 1, nc - 1);
